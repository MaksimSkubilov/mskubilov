...
public class TestKingLikeBishop {
	/**
	 * Test of moving King like Bishop.
	...
	public void whenWrongSourceCellThenThereIsFigureNotFoundException()
		...
		board.setFigure(new King(new Cell('d', 4)));
		boolean move = false;
		move = board.move(new Cell('d', 5), new Cell('d', 2));
	}
	/**
	...
	public void whenWrongDestCellThenThereIsImpossibleMoveException()
		...
		board.setFigure(new King(new Cell('d', 4)));
		boolean move = false;
		move = board.move(new Cell('d', 4), new Cell('b', 2));
	}
	/**
	...
	public void whenThereIsAFigureOnTheWayThenThereIsOccupiedWayException()
		...
		Board board = new Board();
		board.fillBoard();
		board.setFigure(new King(new Cell('f', 6)));
		boolean move = false;
		move = board.move(new Cell('f', 6), new Cell('g', 7));
	}
}